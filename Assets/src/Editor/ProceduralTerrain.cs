...
public class ProceduralTerrain : MonoBehaviour {
	...
	void Start () {
		...
		mesh.Optimize();
        // AssetDatabase.CreateAsset(mesh, "Assets/AsteroidOutsideNormals2.asset");
        // ReverseFaces();
        // AssetDatabase.CreateAsset(mesh, "Assets/ProceduralTerrain/Planet01.asset");
        // PrefabUtility.CreatePrefab("Assets/Asteroid.prefab", this.gameObject);

        AssetDatabase.CreateAsset(mesh, "Assets/Asteroid.asset");
        // ReverseFaces();
	...
	void recenterGeometry(){
        ...
        // AssetDatabase.CreateAsset(mesh, "Assets/PerfectIcosahedronAsteroid.asset");
        // PrefabUtility.CreatePrefab("Assets/Asteroid.asset", this.gameObject);
